      ...
      const grouped = penaltiesData.reduce((acc: { [key: string]: LocationGroup }, penalty) => {
         ...
         if (!acc[key]) {
            acc[key] = {
               ...
               city: penalty.city,
               penalties: [],
               center: { lat: penalty.lat, lng: penalty.lng },
               stats: {
                  total: 0,
                  highRisk: 0,
                  mediumRisk: 0,
      ...
      <div className="w-full h-full flex flex-col bg-gray-900 text-white rounded-lg overflow-hidden shadow-2xl">
         ...
         <div className="flex-1 flex flex-col lg:flex-row min-h-0">
            ...
            <div className="flex-1 relative min-h-[500px]">
               ...
               >
                  {filteredLocations.map((location) => (
                     <Marker key={location.cp} longitude={location.center.lng} latitude={location.center.lat}>
                  ...
                  {popupVisible && selectedLocation && (
                     <Popup
                        longitude={selectedLocation.center.lng}
